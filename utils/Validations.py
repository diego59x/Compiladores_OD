...
def validateIfClause(scope, formals, symbols_table, condition, recursion_depth=0):
    ...
    if type == 'Variable':
        ...
        if condition in symbols_table[scope]['variables']:
            ...
            return False, f'{ condition } is not defined in the current scope.'
    elif type == 'Bool':
        return True, 'Success'
    else:
...
def validateSum(val1, val2, symbols_table, scope, formals):
    ...
    if (valid1 and valid2) and (type1 == 'Int' and type2 == 'Int'):
        ...
        if type1 == 'Variable':
            ...
            if not var_exists:
                return False, f'{ val1 } is not defined in the current scope.'
            if isLocal:
                type1 = formals[val1]
            else:
        ...
        if type2 == 'Variable':
            ...
            if not var_exists:
                return False, f'{ val2 } is not defined in the current scope.'
            if isLocal:
                type2 = formals[val2]
            else:
...
def validateAssignVal(scope, formals, symbols_table, var_name, value_to_assign, initial_expect='', initial_var='' ,recursion_depth=0):
    ...
    if current_type == 'Variable':
        ...
        if value_to_assign in symbols_table[scope]['variables']:
            ...
            return False, f'{ value_to_assign } is not defined in the current scope.'
